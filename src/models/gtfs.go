...
/* GTFS FILE-MODEL MAP */
var GTFS_FILE_RULES_MAP = map[string]func(){
	"afetacao.txt":             rules.AfetacaoRules,
	"agency.txt":               rules.AgencyRules,
	"archives.txt":             rules.ArchiveRules,
	"areas.txt":                rules.AreaRules,
	"attributions.txt":         rules.AttributionRules,
	"booking_rules.txt":        rules.BookingRuleRules,
	"calendar.txt":             rules.CalendarRules,
	"calendar_dates.txt":       rules.CalendarDatesRules,
	"fare_attributes.txt":      rules.FareAttributesRules,
	"fare_leg_join_rules.txt":  rules.FareLegJoinRuleRules,
	"fare_leg_rules.txt":       rules.FareLegRuleRules,
	"fare_media.txt":           rules.FareMediaRules,
	"fare_products.txt":        rules.FareProductRules,
	"fare_rules.txt":           rules.FareRules,
	"fare_transfer_rules.txt":  rules.FareTransferRule,
	"feed_info.txt":            rules.FeedInfo,
	"frequencies.txt":          rules.Frequencies,
	"levels.txt":               rules.Levels,
	"location_group_stops.txt": rules.LocationGroupStop,
	"location_groups.txt":      rules.LocationGroup,
	"municipalities.txt":       rules.Municipality,
	"networks.txt":             rules.Network,
	"pathways.txt":             rules.Pathways,
	"periods.txt":              rules.Period,
	"rider_categories.txt":     rules.RiderCategory,
	"route_networks.txt":       rules.RouteNetwork,
	"routes.txt":               rules.Route,
	"shapes.txt":               rules.Shapes,
	"stop_areas.txt":           rules.StopArea,
	"stop_times.txt":           rules.StopTime,
	"stops.txt":                rules.Stop,
	"timeframes.txt":           rules.Timeframe,
	"transfers.txt":            rules.Transfers,
	"translations.txt":         rules.Translations,
	"trips.txt":                rules.Trip,
}
