...
func FrontDisplayValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("front_display", "vehicles.txt", "front_display_validation", "front_display_count_non_negative_and_rules", row, services.AppMessageService)
