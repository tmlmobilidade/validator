...
func RegistrationDateValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("registration_date", "vehicles.txt", "registration_date_validation", "registration_date_valid_day_granularity", row, services.AppMessageService)
