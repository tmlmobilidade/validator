...
func AvailableStandingValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("available_standing", "vehicles.txt", "available_standing_validation", "available_standing_non_negative_and_rules", row, services.AppMessageService)
