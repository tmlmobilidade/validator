...
func InternalSoundValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("internal_sound", "vehicles.txt", "internal_sound_validation", "internal_sound_level_valid_enum_and_rules", row, services.AppMessageService)
