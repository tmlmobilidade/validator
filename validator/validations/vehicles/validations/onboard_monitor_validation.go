...
func OnboardMonitorValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("onboard_monitor", "vehicles.txt", "onboard_monitor_validation", "onboard_monitor_valid_enum_and_rules", row, services.AppMessageService)
