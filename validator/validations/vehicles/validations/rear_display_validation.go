...
func RearDisplayValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("rear_display", "vehicles.txt", "rear_display_validation", "rear_display_count_non_negative_and_rules", row, services.AppMessageService)
