...
func SideDisplayValidation(vehicle *types.Vehicle, row int, rules *types.VehiclesRules) {
	ctx := lib.NewValidationContext("side_display", "vehicles.txt", "side_display_validation", "side_display_count_non_negative_and_rules", row, services.AppMessageService)
