...
func DirectionIdValidation(trip *types.Trip, row int, gtfs *types.Gtfs, rules *types.TripsRules) {
	ctx := lib.NewValidationContext("direction_id", "trips.txt", "direction_id_validation", "direction_id_valid_binary_or_empty_and_rules", row, services.AppMessageService)
