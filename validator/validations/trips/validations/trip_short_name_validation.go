...
func TripShortNameValidation(trip *types.Trip, row int, gtfs *types.Gtfs, rules *types.TripsRules) {
	ctx := lib.NewValidationContext("trip_short_name", "trips.txt", "trip_short_name_validation", "trip_short_name_exclusivity_with_trip_headsign", row, services.AppMessageService)
