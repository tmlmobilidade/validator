...
func RiderCategoryNameValidation(riderCategory *types.RiderCategory, row int, rules *types.RiderCategoriesRules) {
	ctx := lib.NewValidationContext("rider_category_name", "rider_categories.txt", "rider_category_name_validation", "rider_category_name_rule", row, services.AppMessageService)
