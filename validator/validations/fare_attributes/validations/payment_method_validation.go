...
func PaymentMethodValidation(fareAttribute *types.FareAttribute, row int) {
	ctx := lib.NewValidationContext("payment_method", "fare_attributes.txt", "payment_method_validation", "payment_method_valid_gtfs_enum", row, services.AppMessageService)
