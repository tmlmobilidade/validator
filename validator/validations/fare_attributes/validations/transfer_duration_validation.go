...
func TransferDurationValidation(fareAttribute *types.FareAttribute, row int, gtfs *types.Gtfs, rules *types.FareAttributesRules) {
	ctx := lib.NewValidationContext("transfer_duration", "fare_attributes.txt", "transfer_duration_validation", "validate_transfer_duration", row, services.AppMessageService)
