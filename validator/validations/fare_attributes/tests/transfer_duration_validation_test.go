...
func TestTransferDurationValidation_MissingRequired(t *testing.T) {
	...
	gtfs := &types.Gtfs{}
	validations.TransferDurationValidation(&severity, fareAttribute, 1, gtfs)
...
func TestTransferDurationValidation_MissingWarning(t *testing.T) {
	...
	gtfs := &types.Gtfs{}
	validations.TransferDurationValidation(&severity, fareAttribute, 2, gtfs)
	assertion := lib.AssertionMessage{
		Expected: 1,
...
func TestTransferDurationValidation_MissingIgnore(t *testing.T) {
	...
	gtfs := &types.Gtfs{}
	validations.TransferDurationValidation(&severity, fareAttribute, 3, gtfs)
	assertion := lib.AssertionMessage{
		Expected: 0,
		Actual: services.AppMessageService.GetSummary().TotalErrors,
...
func TestTransferDurationValidation_NegativeDuration(t *testing.T) {
	...
	severity := types.SEVERITY_ERROR
	gtfs := &types.Gtfs{}
	validations.TransferDurationValidation(&severity, fareAttribute, 4, gtfs)
	assertion := lib.AssertionMessage{
		Expected: 1,
		Actual: services.AppMessageService.GetSummary().TotalErrors,
...
func TestTransferDurationValidation_ValidDuration(t *testing.T) {
	...
	severity := types.SEVERITY_ERROR
	gtfs := &types.Gtfs{}
	validations.TransferDurationValidation(&severity, fareAttribute, 5, gtfs)
	assertion := lib.AssertionMessage{
		Expected: 0,
		Actual: services.AppMessageService.GetSummary().TotalErrors,
