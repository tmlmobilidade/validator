...
func HasTariffsInformationValidation(stop *types.Stop, row int, rules *types.StopsRules) {
	ctx := lib.NewValidationContext("has_tariffs_information", "stops.txt", "has_tariffs_information_validation", "has_tariffs_information_rule", row, services.AppMessageService)
