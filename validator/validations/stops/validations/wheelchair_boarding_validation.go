...
func WheelchairBoardingValidation(stop *types.Stop, row int, rules *types.StopsRules) {
	ctx := lib.NewValidationContext("wheelchair_boarding", "stops.txt", "wheelchair_boarding_validation", "wheelchair_boarding_valid_enum", row, services.AppMessageService)
