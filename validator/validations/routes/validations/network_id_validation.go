...
func NetworkIdValidation(route *types.Route, row int, gtfs *types.Gtfs, rules *types.RoutesRules) {
	ctx := lib.NewValidationContext("network_id", "routes.txt", "network_id_validation", "network_id_references_networks_table_and_rules", row, services.AppMessageService)
