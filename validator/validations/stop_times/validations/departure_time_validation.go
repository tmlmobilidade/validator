...
func DepartureTimeValidation(stopTime *types.StopTime, row int, gtfs *types.Gtfs, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("departure_time", "stop_times.txt", "departure_time_validation", "departure_time_ordering_with_arrival_and_timepoint", row, services.AppMessageService)
