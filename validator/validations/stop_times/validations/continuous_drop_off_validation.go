...
func ContinuousDropOffValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("continuous_drop_off", "stop_times.txt", "continuous_drop_off_validation", "stop_times_continuous_drop_off_valid_gtfs_enum", row, services.AppMessageService)
