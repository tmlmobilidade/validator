...
func DropOffTypeValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("drop_off_type", "stop_times.txt", "drop_off_type_validation", "drop_off_type_valid_gtfs_enum_and_rules", row, services.AppMessageService)
