...
func ShapeDistTraveledValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("shape_dist_traveled", "stop_times.txt", "shape_dist_traveled_validation", "stop_times_shape_dist_traveled_non_decreasing_on_trip", row, services.AppMessageService)
