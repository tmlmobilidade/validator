...
func ShapeDistTraveledValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("shape_dist_traveled", "stop_times.txt", "shape_dist_traveled_validation", "check_shape_dist_traveled", row, services.AppMessageService)
