...
func EndPickupDropOffWindowValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("end_pickup_drop_off_window", "stop_times.txt", "end_pickup_drop_off_window_validation", "end_pickup_drop_off_window_rule", row, services.AppMessageService)
