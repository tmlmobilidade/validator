...
func EndPickupDropOffWindowValidation(stopTime *types.StopTime, row int, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("end_pickup_drop_off_window", "stop_times.txt", "end_pickup_drop_off_window_validation", "validate_end_pickup_drop_off_window", row, services.AppMessageService)
