...
func PickupBookingRuleIdValidation(stopTime *types.StopTime, row int, gtfs *types.Gtfs, rules *types.StopTimesRules) {
	ctx := lib.NewValidationContext("pickup_booking_rule_id", "stop_times.txt", "pickup_booking_rule_id_validation", "pickup_booking_rule_id_references_booking_rules", row, services.AppMessageService)
