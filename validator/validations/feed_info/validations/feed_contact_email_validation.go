...
func FeedContactEmailValidation(severity *types.Severity, feedInfo *types.FeedInfo, row int) {
	ctx := lib.NewValidationContext("feed_contact_email", "feed_info.txt", "feed_contact_email_validation", "feed_contact_email_valid_address", row, services.AppMessageService)
	if severity != nil {
