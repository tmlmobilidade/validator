...
func FeedPublisherNameValidation(feedInfo *types.FeedInfo, row int) {
	ctx := lib.NewValidationContext("feed_publisher_name", "feed_info.txt", "feed_publisher_name_validation", "feed_publisher_name_non_empty", row, services.AppMessageService)
